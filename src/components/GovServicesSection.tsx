      ...
      <div className="section-container relative z-10">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 flex justify-center">
            <div className="relative w-72 h-44 rounded-2xl bg-gradient-to-br from-ncrypt-dark-blue/60 to-ncrypt-dark/60 border border-ncrypt-blue/40 p-6">
              <div className="absolute top-4 left-4 w-10 h-8 rounded bg-yellow-300/90"></div>
              <div className="absolute top-4 right-4">
                <div className="w-6 h-6 border-2 border-white/80 rounded-full relative">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm">Age: {selectedUser.age}</p>
                  </div>
                </div>
