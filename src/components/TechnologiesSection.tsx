...
const TechnologiesSection: React.FC = () => {
  ...
  const technologies = [
    {
      ...
      icon: (
        <svg className="w-12 h-12 text-ncrypt-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <section id="technologies" ref={sectionRef} className="py-24 relative overflow-hidden bg-ncrypt-dark-blue/30">
      {/* Background Elements */}
      ...
      <div className="section-container relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {technologies.map((tech, index) => (
            <div
              ...
              className="appear-animate cyberpunk-card p-6 transition-all duration-300 group hover:scale-[1.02]"
        ...
        <div
          ref={(el) => addToRefs(el, technologies.length + 1)}
          className="appear-animate mt-16 max-w-4xl mx-auto"
          ...
          <div className="cyberpunk-card p-6">
            ...
            <div className="relative p-6 bg-ncrypt-dark/60 rounded-lg border border-ncrypt-blue/30">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-8 justify-center w-full">
                  <div className="flex-1 p-4 bg-ncrypt-dark border border-ncrypt-blue/40 rounded-lg flex flex-col items-center">
                    ...
                    <span className="text-xs font-medium text-center">Voter Database</span>
                  </div>
                  <div className="flex-1 p-4 bg-ncrypt-dark border border-ncrypt-blue/40 rounded-lg flex flex-col items-center">
                    <svg className="w-6 h-6 text-ncrypt-blue mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                    </svg>
                    <span className="text-xs font-medium text-center">Blockchain Ledger</span>
                  </div>
                  <div className="flex-1 p-4 bg-ncrypt-dark border border-ncrypt-blue/40 rounded-lg flex flex-col items-center">
                    <svg className="w-6 h-6 text-ncrypt-blue mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <span className="text-xs font-medium text-center">Service Access Log</span>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 opacity-10">
                <div className="w-full h-full border-2 border-ncrypt-blue rounded-full animate-slow-spin" style={{ animationDuration: '40s' }}></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 border-2 border-ncrypt-blue rounded-full animate-slow-spin" style={{ animationDuration: '30s', animationDirection: 'reverse' }}></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/2 h-1/2 border-2 border-ncrypt-cyan rounded-full animate-slow-spin" style={{ animationDuration: '20s' }}></div>
              </div>
            </div>
          </div>
        </div>
